...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aicspylibczi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aicspylibczi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add aicspylibczi
# for installing globally
pixi global install aicspylibczi
```
...
It is possible to list all of the versions of `aicspylibczi` available on your platform:
...
```
pixi search aicspylibczi --channel conda-forge
```
